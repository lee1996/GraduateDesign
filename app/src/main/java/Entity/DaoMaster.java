...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        HeightDao.createTable(db, ifNotExists);
        WeightDao.createTable(db, ifNotExists);
        LeftEyeDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        HeightDao.dropTable(db, ifExists);
        WeightDao.dropTable(db, ifExists);
        LeftEyeDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(HeightDao.class);
        registerDaoClass(WeightDao.class);
        registerDaoClass(LeftEyeDao.class);
