...
public class BpByWeekActivity extends Activity {
    private ImmersionBar mImmersionBar;
    @BindView(R.id.bpbyweektomain)
    ImageView bptomain;
    @BindView(R.id.knowledge_week)
    ImageView knowledge;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bpbyweek);
        ...
        knowledge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final NormalDialog dialog = SmartisanDialog.createNormalDialog(BpByWeekActivity.this);
        ...
        mCharts[0] = (LineChart) findViewById(R.id.byweekchart1);
        mCharts[1] = (LineChart) findViewById(R.id.byweekchart2);
        ...
        if(lis.size()<7){
            Toast.makeText(BpByWeekActivity.this,"数据量不够",Toast.LENGTH_SHORT).show();
        }else {
            try {
    ...
    private void setupChart(LineChart mChart, LineData data, int color) {
        ...
        xAxis.setValueFormatter(new IAxisValueFormatter() {
            ...
            public String getFormattedValue(float value, AxisBase axis) {
                ...
                return sdf.format(list.get(((int) value+1)%list.size()).getTime());
    ...
    private LineData getShuzhangData() throws ParseException {
       ...
       // String today=sdf.format(list.get(list.size()-1).getTime());
        //yVals.add(new Entry(0,Float.parseFloat(list.get(list.size()-1).getShuzhang())));
        int j=0;
        for(int i=list.size()-7;i<list.size();i++,j++){
        ...
        LineDataSet set1 = new LineDataSet(yVals, "最近7次舒张压变化");
    ...
    private LineData getShousuogData() throws ParseException {
        ...
        LineDataSet set1 = new LineDataSet(yVals, "最近7次收缩压变化");
        set1.setLineWidth(1.75f);
        set1.setCircleRadius(5f);
        set1.setCircleHoleRadius(2.5f);
        set1.setColor(Color.WHITE);
